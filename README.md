...
- [API](#api)
  ...
  - [`toCodeAction(codeAction, options)`](#tocodeactioncodeaction-options)
  - [`toCodeActionContext(codeActionContext, options)`](#tocodeactioncontextcodeactioncontext-options)
  ...
  - [`toMarkerData(diagnostic, options)`](#tomarkerdatadiagnostic-options)
...
(`{   position: lsp.Position   label: string | Array<lsp.InlayHintLabelPart>   kind?: lsp.InlayHintKind | undefined   textEdits?: Array<lsp.TextEdit> | undefined   tooltip?: string | lsp.MarkupContent | undefined   paddingLeft?: boolean | undefined   paddingRight?: boolean | undefined   data?: any }`).
...
(`{   value: string   tooltip?: string | lsp.MarkupContent | undefined   location?: lsp.Location | undefined   command?: lsp.Command | undefined }`).
...
### `toCodeAction(codeAction, options)`
...
- `options?` (`ToCodeActionOptions | undefined`) — additional options needed to construct the Monaco
  code action
...
### `toCodeActionContext(codeActionContext, options)`
...
- `options?` (`ToCodeActionContextOptions | undefined`) — additional options needed to construct the
  Monaco code action context
...
- `options?` (`ToMarkerDataOptions | undefined`) — additional options needed to construct the Monaco
  marker data
